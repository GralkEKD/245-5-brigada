...
//Запрашиваем исходное изображение
        Image img = Toolkit.getDefaultToolkit().getImage("src/main/java/KGSAPR/lab5/images/sa.jpg");
...
//Устанавливаем ширину и высоту окна как ширина и высота изображенияthis.setSize(w, h);
